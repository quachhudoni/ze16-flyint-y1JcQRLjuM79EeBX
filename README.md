...
我希望旧版 .NET 平台（例如 .NET Framework、.NET Standard、.NET 6）也能享受这种“反射级灵活 + 原生级性能”的能力.于是我编写了 **[ILAccess.Fody](https://github.com)**. 它实现了和 `UnsafeAccessor` 几乎一致的语法和体验, 但通过 [Fody](https://github.com):[surfshark](https://surfsharkcn.com) + [Mono.Cecil](https://github.com) 在编译期修改 IL 来实现.
